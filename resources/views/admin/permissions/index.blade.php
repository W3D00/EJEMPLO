<x-layouts.admin>
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{route('admin.permissions.create')}}" class="btn btn-blue text-xs">
            Nuevo
        </a>
    </div>
                ...
                @foreach ($permissions as $permission)
                    ...
                    <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end space-x-2">
                                ...
                                <form class="delete-form" action="{{route('admin.permissions.destroy', $permission)}}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
