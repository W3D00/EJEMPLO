            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    @can('manage categories')
                        <flux:navlist.item icon="list-bullet" :href="route('admin.categories.index')" :current="request()->routeIs('admin.categories.*')" wire:navigate>{{ __('Categorias') }}</flux:navlist.item>
                    @endcan
                    @can('manage posts')
                    ...
                    @endcan
                    @can('manage roles')
                        <flux:navlist.item icon="lock-open" :href="route('admin.roles.index')" :current="request()->routeIs('admin.roles.*')" wire:navigate>{{ __('Roles') }}</flux:navlist.item>
                    @endcan
                    @can('manage users')
